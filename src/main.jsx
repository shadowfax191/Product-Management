...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader:()=> fetch('https://express-assignment-8wfg1qrc4-shadowfax12385.vercel.app/cartId'),
      ...
      },
      {
        ...
        loader:()=> fetch('https://express-assignment-8wfg1qrc4-shadowfax12385.vercel.app/users'),
      },
      {
        path: "/update/:id",
        element: <PrivateRoute><UpdateData></UpdateData></PrivateRoute>,
        loader:({params})=> fetch(`https://express-assignment-8wfg1qrc4-shadowfax12385.vercel.app/users/${params.id}`),
      }
    ]
  },
]);
